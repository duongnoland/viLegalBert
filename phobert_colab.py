...
def main():
    ...
    import os
    os.makedirs("models/saved_models/level1_classifier/phobert_level1", exist_ok=True)
    os.makedirs("models/saved_models/level2_classifier/phobert_level2", exist_ok=True)
